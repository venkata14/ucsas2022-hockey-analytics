...
Goal: Visualize where on the field players took shots and scored
...
## Visualizing where the shots were taken

We can look to see where Tampa Bay Lightning's defence tends to be weaker
...
```{r, out.width = "600px"}
knitr::include_graphics("images/simpleimage.png")
```
...
```{r, out.width = "600px"}
knitr::include_graphics("images/betterimage.png")
```
